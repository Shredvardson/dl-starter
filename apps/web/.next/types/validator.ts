...
// Validate ../../src/app/(app)/test-monitoring/page.tsx
{
  const handler = {} as typeof import('../../src/app/(app)/test-monitoring/page.js');
  handler satisfies AppPageConfig<'/test-monitoring'>;
}
