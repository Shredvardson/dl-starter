module.exports = [
  ...
  (a) => {
    'use strict';
    (a.s(['default', () => ac], 52204), a.s([], 62355));
    var b = a.i(88859);
    let c = (a, b) => {
        ...
        k = function (h) {
          ...
          return (
            (g = (f = {
                ...
                let { prefix: b, experimentalParseClassName: c } = a,
                  d = (a) => {
                    ...
                    return {
                      ...
                      baseClassName: i,
                      maybePostfixModifierPosition: b && b > g ? b - g : void 0,
                    };
                  };
                if (b) {
                  let a = b + ':',
              ...
              sortModifiers: ((a) => {
                let b = Object.fromEntries(a.orderSensitiveModifiers.map((a) => [a, !0]));
                return (a) => {
                  ...
                  return (
                    a.forEach((a) => {
                      '[' === a[0] || b[a] ? (c.push(...d.sort(), a), (d = [])) : d.push(a);
                    }),
                    c.push(...d.sort()),
                    c
                  );
    ...
    function ab({ className: a, variant: c = 'primary', ...d }) {
      let e =
        'inline-flex items-center justify-center px-4 py-2 rounded-[var(--radius-md)] transition-[background,opacity,box-shadow] duration-1 ease-[var(--ease-std)]';
      return 'ghost' === c
        ? (0, b.jsx)('button', {
            className: aa(
              e,
    ...
    function ac() {
      return (0, b.jsx)('main', {
        ...
        children: (0, b.jsxs)('section', {
          className:
            'max-w-2xl space-y-4 bg-[hsl(var(--surface))] rounded-[var(--radius-lg)] p-8 border border-[hsl(var(--border))]',
          children: [
            (0, b.jsx)('h1', {
              className: 'text-3xl font-semibold text-[hsl(var(--text))]',
              children: 'Your Starter',
            }),
            (0, b.jsx)('p', {
              className: 'text-[hsl(var(--text-muted))]',
              children: 'Lightweight, LLM-friendly baseline. Add features by recipe.',
            }),
            (0, b.jsxs)('div', {
              className: 'flex gap-3',
              children: [
                (0, b.jsx)(ab, { children: 'Get Started' }),
                (0, b.jsx)(ab, { variant: 'ghost', children: 'Learn more' }),
              ],
            }),
          ],
        }),
...
//# sourceMappingURL=apps_web_src_app_page_tsx_c43e3c90._.js.map
