  ...
  (a) => {
    ...
    (a.s(
      [
        ...
        () => R.RenderFromTemplateContext,
        'RootLayoutBoundary',
        () => R.RootLayoutBoundary,
        'SegmentViewNode',
        () => R.SegmentViewNode,
        'SegmentViewStateNode',
        () => R.SegmentViewStateNode,
        'ViewportBoundary',
        () => R.ViewportBoundary,
        '__next_app__',
        () => N,
        'actionAsyncStorage',
        () => R.actionAsyncStorage,
        'captureOwnerStack',
        () => R.captureOwnerStack,
        'collectSegmentData',
        () => R.collectSegmentData,
        'createMetadataComponents',
        () => R.createMetadataComponents,
        'createPrerenderParamsForClientSegment',
        () => R.createPrerenderParamsForClientSegment,
        'createPrerenderSearchParamsForClientPage',
        () => R.createPrerenderSearchParamsForClientPage,
        'createServerParamsForServerSegment',
        () => R.createServerParamsForServerSegment,
        'createServerSearchParamsForServerPage',
        () => R.createServerSearchParamsForServerPage,
        'createTemporaryReferenceSet',
        () => R.createTemporaryReferenceSet,
        'decodeAction',
        () => R.decodeAction,
        'decodeFormState',
        () => R.decodeFormState,
        ...
        () => R.renderToReadableStream,
        'routeModule',
        () => O,
        'serverHooks',
        () => R.serverHooks,
        'taintObjectReference',
        () => R.taintObjectReference,
        'tree',
        () => L,
        'workAsyncStorage',
        () => R.workAsyncStorage,
    ...
    let L = [
              ...
              children: [
                'test-monitoring',
                {
                  children: [
                    ...
                    {
                      metadata: {},
                      page: [() => j, '[project]/apps/web/src/app/(app)/test-monitoring/page.tsx'],
                    },
                  ],
                },
                { metadata: {} },
      ...
      M = ['[project]/apps/web/src/app/(app)/test-monitoring/page.tsx'],
      N = { require: a.r.bind(a), loadChunk: a.l.bind(a) },
      O = new k.AppPageRouteModule({
        definition: {
          kind: l.RouteKind.APP_PAGE,
          page: '/(app)/test-monitoring/page',
          pathname: '/test-monitoring',
          bundlePath: '',
          filename: '',
          appPaths: [],
        },
    ...
    async function P(a, b, c) {
      var d;
      let e = '/(app)/test-monitoring/page';
      e = e.replace(/\/index$/, '') || '/';
      let f = (0, o.getRequestMeta)(a, 'postponed'),
        g = (0, o.getRequestMeta)(a, 'minimalMode'),
        h = await O.prepare(a, b, { srcPage: e, multiZoneDraftMode: !1 });
      if (!h)
        return (
          (b.statusCode = 400),
          b.end('Bad Request'),
      ...
      let {
        ...
        ae = R.pathname || '/',
        af = (0, y.normalizeAppPath)(e),
        { isOnDemandRevalidate: ag } = h,
        ah = O.match(ae, Z),
        ai = !!Z.routes[_],
        aj = !!(ah || ai || Z.routes[af]),
        ak = a.headers['user-agent'] || '',
        al = (0, B.getBotType)(ak),
        am = (0, w.isHtmlBotRequest)(a),
        an =
          (0, o.getRequestMeta)(a, 'isPrefetchRSCRequest') ??
          '1' === a.headers[A.NEXT_ROUTER_PREFETCH_HEADER],
        ao = (0, o.getRequestMeta)(a, 'isRSCRequest') ?? !!a.headers[A.RSC_HEADER],
        ap = (0, z.getIsPossibleServerAction)(a),
        aq =
          (0, t.checkIsAppPPREnabled)(ac.experimental.ppr) &&
        ...
        at = aq ? f : void 0,
        au = aq && ao && !an,
        av = (0, o.getRequestMeta)(a, 'segmentPrefetchRSCRequest'),
        aw = !ak || (0, w.shouldServeStreamingMetadata)(ak, ac.htmlLimitedBots);
      am && aq && ((aj = !1), (aw = !1));
      let ax = !0 === O.isDev || !aj || 'string' == typeof f || au,
        ay = am && aq,
        az = null;
      $ || !aj || ax || ap || at || au || (az = _);
      let aA = az;
      (!aA && O.isDev && (aA = _),
        O.isDev || $ || !aj || !ao || au || (0, r.stripFlightHeaders)(a.headers));
      let aB = {
        ...J,
        tree: L,
        pages: M,
      ...
      W &&
        X &&
        (0, v.setReferenceManifestsSingleton)({
          page: e,
          clientReferenceManifest: X,
          serverActionsManifest: W,
          serverModuleMap: (0, x.createServerModuleMap)({ serverActionsManifest: W }),
        });
      let aC = a.method || 'GET',
        aD = (0, n.getTracer)(),
        aE = aD.getActiveScopeSpan();
      try {
        let d = O.getVaryHeader(_, ad);
        b.setHeader('Vary', d);
        let f = async (c, d) => {
            let e = new s.NodeNextRequest(a),
              f = new s.NodeNextResponse(b);
            return O.render(e, f, d).finally(() => {
              if (!c) return;
              c.setAttributes({ 'http.status_code': b.statusCode, 'next.rsc': !1 });
              let d = aD.getRootSpanAttributes();
              if (!d) return;
              if (d.get('next.span_type') !== p.BaseServerSpan.handleRequest)
          ...
          h = async ({ span: d, postponed: g, fallbackRouteParams: h }) => {
            let i = {
                ...
                params: Q,
                page: af,
                sharedContext: { buildId: j },
                serverComponentsHmrCache: (0, o.getRequestMeta)(a, 'serverComponentsHmrCache'),
                ...
                renderOpts: {
                  ...
                  pageConfig: {},
                  ComponentMod: aB,
                  Component: (0, q.interopDefault)(aB),
                  params: Q,
                  routeModule: O,
                  page: e,
                  postponed: g,
                  ...
                  dir: require('path').join(process.cwd(), O.relativeProjectDir),
                  isDraftMode: $,
                  ...
                  incrementalCache: (0, o.getRequestMeta)(a, 'incrementalCache'),
                  ...
                  onAfterTaskError: () => {},
                  onInstrumentationRequestError: (b, c, d) => O.onRequestError(a, b, d, ab),
                  err: (0, o.getRequestMeta)(a, 'invokeError'),
                  dev: O.isDev,
                },
              },
              l = await f(d, i),
              { metadata: m } = l,
              { cacheControl: n, headers: p = {}, fetchTags: r } = m;
            if (
              (r && (p[F.NEXT_CACHE_TAGS_HEADER] = r),
              (a.fetchMetrics = m.fetchMetrics),
              aj && (null == n ? void 0 : n.revalidate) === 0 && !O.isDev && !aq)
            ) {
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
            ...
            return {
              value: {
                kind: C.CachedRouteKind.APP_PAGE,
                html: l,
                headers: p,
          ...
          i = async ({ hasResolved: d, previousCacheEntry: e, isRevalidating: f, span: i }) => {
            let j,
              k = !1 === O.isDev,
              m = d || b.writableEnded;
            if (ag && aa && !e && !g)
            ...
            if (
              (ah && (j = (0, D.parseFallbackField)(ah.fallback)),
              j === D.FallbackMode.PRERENDER &&
                (0, B.isBot)(ak) &&
                (!aq || am) &&
                (j = D.FallbackMode.BLOCKING_STATIC_RENDER),
              (null == e ? void 0 : e.isStale) === -1 && (ag = !0),
              ag &&
                (j !== D.FallbackMode.NOT_FOUND || e) &&
                (j = D.FallbackMode.BLOCKING_STATIC_RENDER),
              !g &&
                j !== D.FallbackMode.BLOCKING_STATIC_RENDER &&
                aA &&
              ...
              let b;
              if ((k || ah) && j === D.FallbackMode.NOT_FOUND) throw new I.NoFallbackError();
              if (aq && !ao) {
                let d =
                  'string' == typeof (null == ah ? void 0 : ah.fallback)
                    ...
                    : k
                      ...
                      : null;
                if (
                  ((b = await O.handleResponse({
                    cacheKey: d,
                    req: a,
                    nextConfig: ac,
                    routeKind: l.RouteKind.APP_PAGE,
                    isFallback: !0,
                    prerenderManifest: Z,
                    isRoutePPREnabled: aq,
                    responseGenerator: async () =>
                      h({
                        span: i,
                        postponed: void 0,
                        fallbackRouteParams: k || as ? (0, u.getFallbackRouteParams)(af) : null,
                      }),
                    waitUntil: c.waitUntil,
                  })),
                  null === b)
            ...
            let n = ag || f || !at ? void 0 : at;
            if (ar && void 0 !== n)
              return {
                cacheControl: { revalidate: 1, expire: void 0 },
                value: {
                  kind: C.CachedRouteKind.PAGES,
                  html: E.default.EMPTY,
                  pageData: {},
                  headers: void 0,
                  status: void 0,
                },
            ...
            let p =
              S && aq && ((0, o.getRequestMeta)(a, 'renderFallbackShell') || as)
                ? (0, u.getFallbackRouteParams)(ae)
                : null;
            return h({ span: i, postponed: n, fallbackRouteParams: p });
          },
          m = async (d) => {
            var e, f, j, k, m;
            let n,
              p = await O.handleResponse({
                cacheKey: az,
                responseGenerator: (a) => i({ span: d, ...a }),
                routeKind: l.RouteKind.APP_PAGE,
                isOnDemandRevalidate: ag,
                isRoutePPREnabled: aq,
                req: a,
            ...
            if (
              ...
              O.isDev && b.setHeader('Cache-Control', 'no-store, must-revalidate'),
              !p)
            ) {
              if (az)
            ...
            if ((null == (e = p.value) ? void 0 : e.kind) !== C.CachedRouteKind.APP_PAGE)
              throw Object.defineProperty(
                Error(
                  `Invariant app-page handler received invalid cache entry ${null == (j = p.value) ? void 0 : j.kind}`
                ),
                '__NEXT_ERROR_CODE',
            ...
            aj &&
              ...
              b.setHeader(A.NEXT_IS_PRERENDER_HEADER, '1'));
            let { value: r } = p;
            if (at) n = { revalidate: 0, expire: void 0 };
            else if (g && ao && !an && aq) n = { revalidate: 0, expire: void 0 };
            else if (!O.isDev)
                ...
                if (p.cacheControl)
                  if ('number' == typeof p.cacheControl.revalidate) {
                    ...
                    n = {
                      ...
                      expire: (null == (k = p.cacheControl) ? void 0 : k.expire) ?? ac.expireTime,
                    };
                  } else n = { revalidate: F.CACHE_ONE_YEAR, expire: void 0 };
              } else b.getHeader('Cache-Control') || (n = { revalidate: 0, expire: void 0 });
            if (
              ((p.cacheControl = n),
              'string' == typeof av &&
                (null == r ? void 0 : r.kind) === C.CachedRouteKind.APP_PAGE &&
                r.segmentData)
            ) {
              b.setHeader(A.NEXT_DID_POSTPONE_HEADER, '2');
              let c = null == (m = r.headers) ? void 0 : m[F.NEXT_CACHE_TAGS_HEADER];
              g && aj && c && 'string' == typeof c && b.setHeader(F.NEXT_CACHE_TAGS_HEADER, c);
              let d = r.segmentData.get(av);
              return void 0 !== d
                ? (0, H.sendRenderResult)({
                    req: a,
                    res: b,
                    generateEtags: ac.generateEtags,
                    poweredByHeader: ac.poweredByHeader,
                    result: E.default.fromStatic(d, A.RSC_CONTENT_TYPE_HEADER),
                ...
                : ((b.statusCode = 204),
                  (0, H.sendRenderResult)({
                    ...
                    generateEtags: ac.generateEtags,
                    poweredByHeader: ac.poweredByHeader,
                    result: E.default.EMPTY,
                    cacheControl: p.cacheControl,
                  }));
            }
            let s = (0, o.getRequestMeta)(a, 'onCacheEntry');
            if (
              s &&
              (await s(
                { ...p, value: { ...p.value, kind: 'PAGE' } },
                { url: (0, o.getRequestMeta)(a, 'initURL') }
              ))
            )
              return null;
            if (q && at)
            ...
            if (r.headers) {
              let a = { ...r.headers };
              for (let [c, d] of ((g && aj) || delete a[F.NEXT_CACHE_TAGS_HEADER],
              Object.entries(a)))
                if (void 0 !== d)
                  if (Array.isArray(d)) for (let a of d) b.appendHeader(c, a);
                  else ('number' == typeof d && (d = d.toString()), b.appendHeader(c, d));
            }
            let t = null == (f = r.headers) ? void 0 : f[F.NEXT_CACHE_TAGS_HEADER];
            if (
              (g && aj && t && 'string' == typeof t && b.setHeader(F.NEXT_CACHE_TAGS_HEADER, t),
              !r.status || (ao && aq) || (b.statusCode = r.status),
              !g && r.status && K.RedirectStatusCode[r.status] && ao && (b.statusCode = 200),
              q && b.setHeader(A.NEXT_DID_POSTPONE_HEADER, '1'),
              ao && !$)
            ) {
              if (void 0 === r.rscData) {
                if (r.postponed)
              ...
              return (0, H.sendRenderResult)({
                ...
                generateEtags: ac.generateEtags,
                poweredByHeader: ac.poweredByHeader,
                result: E.default.fromStatic(r.rscData, A.RSC_CONTENT_TYPE_HEADER),
                cacheControl: p.cacheControl,
              });
            }
            let u = r.html;
            ...
            if (ar)
              return (
                u.push(
                  new ReadableStream({
                    start(a) {
                      (a.enqueue(G.ENCODED_TAGS.CLOSED.BODY_AND_HTML), a.close());
                    },
                  })
                ),
                (0, H.sendRenderResult)({
            ...
            return (
              ...
              h({ span: d, postponed: r.postponed, fallbackRouteParams: null })
                .then(async (a) => {
                  ...
                  if ((null == (b = a.value) ? void 0 : b.kind) !== C.CachedRouteKind.APP_PAGE)
                    throw Object.defineProperty(
                      Error(
        ...
        throw (
          aE ||
            b instanceof I.NoFallbackError ||
...
//# sourceMappingURL=_1392505f._.js.map
