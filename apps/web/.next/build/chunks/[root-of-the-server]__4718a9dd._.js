module.exports = [
  ...
  '[turbopack-node]/transforms/transforms.ts [webpack_loaders] (ecmascript)',
  ...
  '[externals]/next/dist/compiled/loader-runner [external] (next/dist/compiled/loader-runner, cjs)',
  (__turbopack_context__, module, exports) => {
    const mod = __turbopack_context__.x('next/dist/compiled/loader-runner', () =>
      require('next/dist/compiled/loader-runner')
    );
  ...
  (__turbopack_context__) => {
    ...
    __turbopack_context__.s(['default', () => transform]);
    var __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__ =
      __turbopack_context__.i('[externals]/path [external] (path, cjs)');
    ...
    var __TURBOPACK__imported__module__$5b$turbopack$2d$node$5d2f$transforms$2f$transforms$2e$ts__$5b$webpack_loaders$5d$__$28$ecmascript$29$__ =
      __turbopack_context__.i(
        '[turbopack-node]/transforms/transforms.ts [webpack_loaders] (ecmascript)'
      );
    const { runLoaders } = __turbopack_context__.r(
      '[externals]/next/dist/compiled/loader-runner [external] (next/dist/compiled/loader-runner, cjs)'
    );
    const contextDir = process.cwd();
        ...
        runLoaders(
          {
                ...
                return (lookupPath, request, callback) => {
                  const promise = ipc
                    .sendRequest({
                      ...
                      options: rustOptions,
                      lookupPath: (0,
                      __TURBOPACK__imported__module__$5b$turbopack$2d$node$5d2f$transforms$2f$transforms$2e$ts__$5b$webpack_loaders$5d$__$28$ecmascript$29$__[
                        'toPath'
                      ])(lookupPath),
                      request,
                    })
              ...
              getLogger(name) {
                ...
                return {
                  ...
                  timeAggregate: (label) => {
                    ...
                    const time = process.hrtime(prev);
                    /** @type {Map<string | undefined, [number, number]>} */ timers.delete(label);
                    /** @type {Map<string | undefined, [number, number]>} */ timersAggregates =
                      timersAggregates || new Map();
            ...
            loaders: loadersWithOptions.map((loader) => ({
              loader: /*TURBOPACK member replacement*/ __turbopack_context__.x.resolve(
                loader.loader,
                {
          ...
          (err, result) => {
            ...
            ipc.sendInfo({
              ...
              filePaths: result.fileDependencies.map(
                __TURBOPACK__imported__module__$5b$turbopack$2d$node$5d2f$transforms$2f$transforms$2e$ts__$5b$webpack_loaders$5d$__$28$ecmascript$29$__[
                  'toPath'
                ]
              ),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4718a9dd._.js.map
